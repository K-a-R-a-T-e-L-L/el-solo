...
const ListServices = ({ t }: ListServicesProps) => {
    ...
    return (
        <section className="w-full flex pt-[140px] flex-col items-center justify-center" id="services">
            ...
            <article className="w-full flex justify-center items-center mt-40 perspective-[1000px] max-lg:flex-col gap-y-5">
            ...
            {isOpenPopUp && (
                <PopUpWindow color={'0,50,50'} set={setIsOpenPopUp}>
                    <div className="w-full h-full flex flex-col items-center justify-center gap-y-10">
                        ...
                        <div className="relative w-[60%] aspect-[5/2] overflow-hidden rounded-xl max-xl:rounded-[8px]">
                        ...
                        <hr className="w-[80%] h-[2px]" />
                        <div className="h-[50px] max-xl:h-[40px] max-xl:gap-x-[12px] flex gap-x-[20px] items-center mt-[30px] max-xl:mt-[20px]">
